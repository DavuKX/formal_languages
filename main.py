...
def input_data(alphabets: str):
    ...
    language_1 = invoker.execute_action('kleene_closure', formatted_alphabets, words_number,max_word_length)
    language_2 = invoker.execute_action('kleene_closure', formatted_alphabets, words_number,max_word_length)
